...
const { selectOrderPage, itemsPerPage, currentPage } = useArchivePagination()
const dateSortOrder = ref<'asc' | 'desc'>('asc')
const priceSortOrder = ref<'asc' | 'desc'>('asc')

function sortByDate() {
  archiveStore.sortByDate(dateSortOrder.value)
...
function sortByPrice() {
  archiveStore.sortByPrice(priceSortOrder.value)
  selectOrderPage(currentPage.value, itemsPerPage.value)
