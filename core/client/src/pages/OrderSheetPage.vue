...
import AttributesList from '~/components/review/AttributesList.vue'
import BadgesList from '~/components/review/BadgesList.vue'
import CommentActions from '~/components/review/CommentActions.vue'
